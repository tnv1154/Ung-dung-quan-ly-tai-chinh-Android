...
public class MainActivity extends AppCompatActivity {
    ...
    private void showWalletOptions(UiWallet wallet) {
        ...
        View sheetView = LayoutInflater.from(this).inflate(R.layout.bottom_sheet_wallet_options, null, false);
        dialog.setContentView(sheetView);

        TextView tvWalletName = sheetView.findViewById(R.id.tvWalletOptionsWalletName);
        View btnAdjust = sheetView.findViewById(R.id.btnWalletOptionAdjust);
        ...
        btnAdjust.setEnabled(!wallet.isLocked());
        btnTransfer.setEnabled(!wallet.isLocked());
        btnAdjust.setAlpha(wallet.isLocked() ? 0.45f : 1f);
    ...
    private void startAdjustFlow(UiWallet wallet) {
        Intent intent = new Intent(this, AddTransactionActivity.class);
        intent.putExtra(AddTransactionActivity.EXTRA_PREFILL_MODE, AddTransactionActivity.MODE_ADJUST);
