    ...
    public static void show(
        ...
        for (CheckBox walletCheck : walletChecks) {
            walletCheck.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (!isChecked && selectAllWallets.isChecked()) {
                    selectAllWallets.setChecked(false);
                } else if (isChecked && areAllChecked(walletChecks) && !selectAllWallets.isChecked()) {
                    selectAllWallets.setChecked(true);
                }
            });
        }
