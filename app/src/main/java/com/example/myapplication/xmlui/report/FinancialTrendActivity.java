...
public class FinancialTrendActivity extends AppCompatActivity {
    ...
    private TextView tvTrendTransfer;
    ...
    private void bindViews() {
        ...
        tvTrendTransfer = findViewById(R.id.tvTrendTransfer);
    ...
    private void renderFinanceState(@NonNull FinanceUiState state) {
        ...
        double transfer = sumInRange(state.getTransactions(), currentStart, currentEnd, TransactionType.TRANSFER, walletCurrencyMap);
        ...
        tvTrendIncome.setText(formatCompactMoney(income));
        tvTrendExpense.setText(formatCompactMoney(expense));
        tvTrendTransfer.setText(formatCompactMoney(transfer));
        tvTrendNet.setText(formatCompactMoney(net));
        ...
        if (Math.abs(previousNet) < 0.0001) {
            ...
            String percent = formatPercentRatio(ratio * 100.0);
